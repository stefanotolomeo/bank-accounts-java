...
class AccountManagerIT extends BaseIT {
	...
	void findAll_Test() {
		...
		accountHashOperations.put(Constants.CACHE_ACCOUNT_NAME, id_2, a2);
	...
	@Test
	private void validateAccount_Test() throws InvalidInputException {

		// (1) Invalid Account for INSERT: null
		InvalidInputException e1 = Assertions
				.assertThrows(InvalidInputException.class, () -> accountManager.validateAccount(OperationType.INSERT, null));
		Assertions.assertEquals("Invalid Account: Null Account", e1.getMessage());

		// (2) Invalid Account for INSERT: null name
		Account invalidAccount = new Account(null, null, null, null, null);
		InvalidInputException e2 = Assertions
				.assertThrows(InvalidInputException.class, () -> accountManager.validateAccount(OperationType.INSERT, invalidAccount));
		Assertions.assertEquals("Invalid Account: Null Name", e2.getMessage());

		// (3) Invalid Account for INSERT: null surname
		invalidAccount.setName("NAME");
		InvalidInputException e3 = Assertions
				.assertThrows(InvalidInputException.class, () -> accountManager.validateAccount(OperationType.INSERT, invalidAccount));
		Assertions.assertEquals("Invalid Account: Null Surname", e3.getMessage());

		// (4) Invalid Account for INSERT: null pin
		invalidAccount.setSurname("SURNAME");
		InvalidInputException e4 = Assertions
				.assertThrows(InvalidInputException.class, () -> accountManager.validateAccount(OperationType.INSERT, invalidAccount));
		Assertions.assertEquals("Invalid Account: Null or Empty Pin", e4.getMessage());

		// (5) Invalid Account for INSERT: empty pin
		invalidAccount.setPin("");
		InvalidInputException e5 = Assertions
				.assertThrows(InvalidInputException.class, () -> accountManager.validateAccount(OperationType.INSERT, invalidAccount));
		Assertions.assertEquals("Invalid Account: Null or Empty Pin", e5.getMessage());

		// (6) Invalid Account for INSERT: null amount
		invalidAccount.setPin("12345");
		InvalidInputException e6 = Assertions
				.assertThrows(InvalidInputException.class, () -> accountManager.validateAccount(OperationType.INSERT, invalidAccount));
		Assertions.assertEquals("Invalid Account: Null Amount", e6.getMessage());

		// (7) Valid Account for INSERT: no expection here
		...
		InvalidInputException e7 = Assertions
				.assertThrows(InvalidInputException.class, () -> accountManager.validateAccount(OperationType.UPDATE, invalidAccount));
		Assertions.assertEquals("Invalid Account: Null ID", e7.getMessage());

		// (9) Valid Account for INSERT: no expection here
